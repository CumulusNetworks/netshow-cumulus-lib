...
cd  ../../
git clone -b $GIT_BRANCH https://github.com/CumulusNetworks/cumulus-platform-info
...
cd ../
git clone -b $GIT_BRANCH https://github.com/CumulusNetworks/netshow-linux-lib
